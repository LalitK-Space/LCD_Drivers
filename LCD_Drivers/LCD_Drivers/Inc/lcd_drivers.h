...
#define LCD_GPIO_PORT	GPIOE		// LCD is connected to GPIO port D
#define LCD_GPIO_RS		GPIO_Pin_8	// LCD RS is connected to Pin 0
#define LCD_GPIO_RW		GPIO_Pin_9	// LCD RW is connected to Pin 1
#define LCD_GPIO_E		GPIO_Pin_10	// LCD Enable is connected to Pin 2
#define LCD_GPIO_D4		GPIO_Pin_11	// LCD D4 is connected to Pin 3
#define LCD_GPIO_D5		GPIO_Pin_12	// LCD D5 is connected to Pin 4
#define LCD_GPIO_D6		GPIO_Pin_13	// LCD D6 is connected to Pin 5
#define LCD_GPIO_D7		GPIO_Pin_14	// LCD D7 is connected to Pin 6
